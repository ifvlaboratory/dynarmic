...
#define INST(fn, name, bitstring) Decoder::detail::detail<Thumb32Matcher<V>>::GetMatcher(fn, name, bitstring)
        ...
        INST(&V::thumb32_PUSH,           "PUSH",                     "11101001001011010M0xxxxxxxxxxxxx"),
        ...
        INST(&V::thumb32_STRD_imm_2,     "STRD (imm)",               "1110100PU1W0nnnnttttddddvvvvvvvv"),
        ...
        INST(&V::thumb32_LSR_imm,        "LSR (imm)",                "11101010010S11110iiiddddmm01rrrr"),
        INST(&V::thumb32_ASR_imm,        "ASR (imm)",                "11101010010S11110iiiddddmm10rrrr"),
        INST(&V::thumb32_RRX,            "RRX",                      "11101010010S11110000dddd0011rrrr"),
        INST(&V::thumb32_ROR_imm,        "ROR (imm)",                "11101010010S11110iiiddddmm11rrrr"),
        INST(&V::thumb32_ORR_reg,        "ORR (reg)",                "11101010010Snnnn0iiiddddmmttrrrr"),
        INST(&V::thumb32_MVN_reg,        "MVN (reg)",                "11101010011S11110iiiddddmmttrrrr"),
        INST(&V::thumb32_ORN_reg,        "ORN (reg)",                "11101010011Snnnn0iiiddddmmttrrrr"),
        INST(&V::thumb32_TEQ_reg,        "TEQ (reg)",                "111010101001nnnn0iii1111mmttrrrr"),
        INST(&V::thumb32_EOR_reg,        "EOR (reg)",                "11101010100Snnnn0iiiddddmmttrrrr"),
        INST(&V::thumb32_PKH,            "PKH",                      "111010101100nnnn0iiiddddmmt0rrrr"),
        INST(&V::thumb32_CMN_reg,        "CMN (reg)",                "111010110001nnnn0iii1111mmttrrrr"),
        INST(&V::thumb32_ADD_reg,        "ADD (reg)",                "11101011000Snnnn0iiiddddmmttrrrr"),
        INST(&V::thumb32_ADC_reg,        "ADC (reg)",                "11101011010Snnnn0iiiddddmmttrrrr"),
        ...
        INST(&V::thumb32_BIC_imm,        "BIC (imm)",                "11110i00001Snnnn0kkkddddmmmmmmmm"),
        ...
        INST(&V::thumb32_MVN_imm,        "MVN (imm)",                "11110i00011S11110kkkddddmmmmmmmm"),
        INST(&V::thumb32_ORN_imm,        "ORN (imm)",                "11110i00011Snnnn0kkkddddmmmmmmmm"),
        ...
        INST(&V::thumb32_ADC_imm,        "ADC (imm)",                "11110i01010Snnnn0kkkddddmmmmmmmm"),
        INST(&V::thumb32_SBC_imm,        "SBC (imm)",                "11110i01011Snnnn0kkkddddmmmmmmmm"),
        INST(&V::thumb32_CMP_imm,        "CMP (imm)",                "11110i011011nnnn0kkk1111mmmmmmmm"),
        INST(&V::thumb32_SUB_imm_1,      "SUB (imm)",                "11110i01101Snnnn0kkkddddmmmmmmmm"),
        ...
        INST(&V::thumb32_SUB_imm_2,      "SUBW (imm)",               "11110i101010nnnn0kkkddddmmmmmmmm"),
        INST(&V::thumb32_MOVT,           "MOVT",                     "11110i101100kkkk0mmmddddaaaaaaaa"),
        INST(&V::thumb32_SSAT16,         "SSAT16",                   "111100110010nnnn0000dddd000mmmmm"),
        INST(&V::thumb32_SSAT,           "SSAT",                     "1111001100s0nnnn0kkkddddii0mmmmm"),
        INST(&V::thumb32_SBFX,           "SBFX",                     "111100110100nnnn0kkkddddii0mmmmm"),
        INST(&V::thumb32_BFC,            "BFC",                      "11110011011011110kkkddddii0mmmmm"),
        ...
        INST(&V::thumb32_STRB_imm_2,     "STRB (imm)",               "111110001000nnnnttttmmmmmmmmmmmm"),
        INST(&V::thumb32_STRB,           "STRB (reg)",               "111110000000nnnntttt000000ssrrrr"),
        INST(&V::thumb32_STRH_imm_1,     "STRH (imm)",               "111110000010nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_STRH_imm_3,     "STRH (imm)",               "111110001010nnnnttttmmmmmmmmmmmm"),
        //INST(&V::thumb32_STRHT,          "STRHT",                    "111110000010--------1110--------"),
        INST(&V::thumb32_STRH,           "STRH (reg)",               "111110000010nnnntttt000000ssrrrr"),
        INST(&V::thumb32_STR_imm_1,      "STR (imm)",                "111110000100nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_STR_imm_3,      "STR (imm)",                "111110001100nnnnttttmmmmmmmmmmmm"),
        //INST(&V::thumb32_STRT,           "STRT",                     "111110000100--------1110--------"),
        INST(&V::thumb32_STR_reg,        "STR (reg)",                "111110000100nnnntttt000000ssrrrr"),
        ...
        INST(&V::thumb32_LDRB_lit,       "LDRB (lit)",               "11111000u0011111ttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRB_reg,       "LDRB (reg)",               "111110000001nnnntttt000000ssrrrr"),
        //INST(&V::thumb32_LDRBT,          "LDRBT",                    "111110000001--------1110--------"),
        INST(&V::thumb32_LDRB_imm8,      "LDRB (imm8)",              "111110000001nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_LDRB_imm12,     "LDRB (imm12)",             "111110001001nnnnttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRSB_lit,      "LDRSB (lit)",              "11111001u0011111ttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRSB_reg,      "LDRSB (reg)",              "111110010001nnnntttt000000ssrrrr"),
        //INST(&V::thumb32_LDRSBT,         "LDRSBT",                   "111110010001--------1110--------"),
        INST(&V::thumb32_LDRSB_imm8,     "LDRSB (imm8)",             "111110010001nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_LDRSB_imm12,    "LDRSB (imm12)",            "111110011001nnnnttttmmmmmmmmmmmm"),

        // Load Halfword and Memory Hints
        INST(&V::thumb32_LDRH_lit,       "LDRH (lit)",               "11111000u0111111ttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRH_reg,       "LDRH (reg)",               "111110000011nnnntttt000000ssrrrr"),
        //INST(&V::thumb32_LDRHT,          "LDRHT",                    "111110000011--------1110--------"),
        INST(&V::thumb32_LDRH_imm8,      "LDRH (imm8)",              "111110000011nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_LDRH_imm12,     "LDRH (imm12)",             "111110001011nnnnttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRSH_lit,      "LDRSH (lit)",              "11111001u0111111ttttmmmmmmmmmmmm"),
        INST(&V::thumb32_LDRSH_reg,      "LDRSH (reg)",              "111110010011nnnntttt000000ssrrrr"),
        //INST(&V::thumb32_LDRSHT,         "LDRSHT",                   "111110010011--------1110--------"),
        INST(&V::thumb32_LDRSH_imm8,     "LDRSH (imm8)",             "111110010011nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_LDRSH_imm12,    "LDRSH (imm12)",            "111110011011nnnnttttmmmmmmmmmmmm"),
        ...
        // Load Word
        INST(&V::thumb32_LDR_lit,        "LDR (lit)",                "11111000u1011111ttttmmmmmmmmmmmm"),
        //INST(&V::thumb32_LDRT,           "LDRT",                     "111110000101--------1110--------"),
        INST(&V::thumb32_LDR_reg,        "LDR (reg)",                "111110000101nnnntttt000000ssrrrr"),
        INST(&V::thumb32_LDR_imm8,       "LDR (imm8)",               "111110000101nnnntttt1puwmmmmmmmm"),
        INST(&V::thumb32_LDR_imm12,      "LDR (imm12)",              "111110001101nnnnttttmmmmmmmmmmmm"),
        ...
        INST(&V::thumb32_UXTB,           "UXTB",                     "11111010010111111111dddd10rrmmmm"),
        ...
        INST(&V::thumb32_REV,            "REV",                      "111110101001mmmm1111dddd1000mmmm"),
        //INST(&V::thumb32_REV16,          "REV16",                    "111110101001----1111----1001----"),
        INST(&V::thumb32_RBIT,           "RBIT",                     "111110101001mmmm1111dddd1010mmmm"),
        //INST(&V::thumb32_REVSH,          "REVSH",                    "111110101001----1111----1011----"),
        //INST(&V::thumb32_SEL,            "SEL",                      "111110101010----1111----1000----"),
        INST(&V::thumb32_CLZ,            "CLZ",                      "111110101011mmmm1111dddd1000mmmm"),
