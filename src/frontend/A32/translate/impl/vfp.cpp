...
// VSUB<c>.F64 <Dd>, <Dn>, <Dm>
// VSUB<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VSUB(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VMLA<c>.F64 <Dd>, <Dn>, <Dm>
// VMLA<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VMLA(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VMLS<c>.F64 <Dd>, <Dn>, <Dm>
// VMLS<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VMLS(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VNMUL<c>.F64 <Dd>, <Dn>, <Dm>
// VNMUL<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VNMUL(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VNMLS<c>.F64 <Dd>, <Dn>, <Dm>
// VNMLS<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VNMLS(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VDIV<c>.F64 <Dd>, <Dn>, <Dm>
// VDIV<c>.F32 <Sd>, <Sn>, <Sm>
bool ThumbTranslatorVisitor::vfp_VDIV(bool D, size_t Vn, size_t Vd, bool sz, bool N, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VABS<c>.F64 <Dd>, <Dm>
// VABS<c>.F32 <Sd>, <Sm>
bool ThumbTranslatorVisitor::vfp_VABS(bool D, size_t Vd, bool sz, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VCMP{E}.F32 <Sd>, <Sm>
// VCMP{E}.F64 <Dd>, <Dm>
bool ThumbTranslatorVisitor::vfp_VCMP(bool D, size_t Vd, bool sz, bool E, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VCVT<c>.F64.F32 <Dd>, <Sm>
// VCVT<c>.F32.F64 <Sd>, <Dm>
bool ThumbTranslatorVisitor::vfp_VCVT_f_to_f(bool D, size_t Vd, bool sz, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VCVT{,R}.U32.F32 <Sd>, <Sm>
// VCVT{,R}.U32.F64 <Sd>, <Dm>
bool ThumbTranslatorVisitor::vfp_VCVT_to_u32(bool D, size_t Vd, bool sz, bool round_towards_zero, bool M, size_t Vm) {
    if (!ConditionPassed()) {
        return true;
    }
...
// VSTM{mode}<c> <Rn>{!}, <list of double registers>
bool ThumbTranslatorVisitor::vfp_VSTM_a1(bool p, bool u, bool D, bool w, Reg n, size_t Vd, Imm<8> imm8) {
    if (!ConditionPassed()) {
        return true;
    }
    if (!p && !u && !w) {
...
// VLDM{mode}<c> <Rn>{!}, <list of double registers>
bool ThumbTranslatorVisitor::vfp_VLDM_a1(bool p, bool u, bool D, bool w, Reg n, size_t Vd, Imm<8> imm8) {
    if (!ConditionPassed()) {
        return true;
    }
    if (!p && !u && !w) {
...
// VLDM{mode}<c> <Rn>{!}, <list of single registers>
bool ThumbTranslatorVisitor::vfp_VLDM_a2(bool p, bool u, bool D, bool w, Reg n, size_t Vd, Imm<8> imm8) {
    if (!ConditionPassed()) {
        return true;
    }
    if (!p && !u && !w) {
